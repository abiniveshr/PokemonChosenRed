...
//FOLLOWER MON HAS SPRITE ID 20 DONT USE SPRITE ID 20 FOR ANYTHING//


  special 225
  call <1049E05>
Hides your following mon

Flags used by me:

top slot pokemon following : 0x1055
...
Some Radical Red Specials:
check if pokemon is following: special 225 (returns yes/no)
hide following pokemon till next interaction: special 211
hide following pokemon definitely: special 210
show following pokemon: special 209
(for hide and show make sure to use the flag 0x1055)
...
-Shadow system
-Edit the title cards and credits cards to fit Chosen Red
